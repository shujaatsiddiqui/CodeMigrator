...
/// <summary>
/// Generates xUnit test classes and methods.
/// </summary>
public class XUnitTestGenerator : ITestGenerator
{
    public string Name => "xUnit Test Generator";
    public string Framework => "xUnit";
    ...
    public string GenerateTestClass(string className, IEnumerable<MethodMetadata> methods)
    {
        ...
        {
            sb.AppendLine($"    private readonly Mock<{dep.TypeName}> _{ToCamelCase(dep.TypeName)}Mock;");
        }
